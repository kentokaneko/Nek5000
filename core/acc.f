...
!$acc update device(tlag,vgradt1,vgradt2)
...
c!$acc update device(mg_nx)
c!$acc update device(mg_ny,mg_nz)
c!$acc update device(mg_nh,mg_nhz)
c!$acc update device(mg_gsh_schwarz_handle)
c!$acc update device(mg_gsh_handle)
c!$acc update device(mg_rstr_wt_index)
c!$acc update device(mg_mask_index)
c!$acc update device(mg_solve_index)
c!$acc update device(mg_fast_s_index)
c!$acc update device(mg_fast_d_index)
c!$acc update device(mg_schwarz_wt_index)
c!$acc update device(mg_g_index)
c
c!$acc update device(mg_jh)
c!$acc update device(mg_jht)
c!$acc update device(mg_jhfc )
c!$acc update device(mg_jhfct)
c!$acc update device(mg_ah)
c!$acc update device(mg_bh)
c!$acc update device(mg_dh)
c!$acc update device(mg_dht)
c!$acc update device(mg_zh)
c!$acc update device(mg_rstr_wt)
c!$acc update device(mg_mask)
c!$acc update device(mg_fast_s)
c!$acc update device(mg_fast_d)
c!$acc update device(mg_schwarz_wt)
c!$acc update device(mg_solve_e)
c!$acc update device(mg_solve_r)
c!$acc update device(mg_h1)
c!$acc update device(mg_h2)
c!$acc update device(mg_b)
c!$acc update device(mg_g)
c!$acc update device(mg_work)
c!$acc update device(mg_work2)
c!$acc update device(mg_worke)
c
c!$acc update device(mg_imask)
c
c!$acc update device(mg_h1_n)
c!$acc update device(p_mg_h1)
c!$acc update device(p_mg_b)
c!$acc update device(p_mg_msk)
