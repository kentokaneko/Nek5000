### makefile automatically created by makenek 09/08/2017 11:18:48 ###
BINNAME=dev.nek5000
LIBNAME=libnek5000.dev.a
CASENAME:=ethier
CASEDIR:=/home/kaneko/ethier
S:=/home/kaneko/dev/core
SCMT:=/home/kaneko/dev/core/cmt
J:=/home/kaneko/dev/jl
OPT_INCDIR=./
OBJDIR=dev.obj
IFMPI:=true
IFCMT:=false
...
FC:=mpif77
CC:=mpicc
FFLAGS:=-r8 -Mpreprocess
CFLAGS:=-DNEW_GS_LOOPS
PPPO=
PPS= MPI UNDERSCORE TIMER MPITIMER GLOBAL_LONG_LONG
G:=-mcmodel=medium -acc -Minfo=accel -ta=nvidia:cc50,cc60,cuda8.0
USR:=
USR_LFLAGS:=-mcmodel=medium -acc -Minfo=accel -ta=nvidia:cc50,cc60,cuda8.0
IFVISIT=
VISIT_IFLAGS=
VISIT_LFLAGS=
...
readat_new.o reader_re2.o finiparser.o iniparser.o dictionary.o acc.o
################################################################################
# MXM 
MXM=mxm_std.o
################################################################################
...
$(OBJDIR)/acc.o	:$S/acc.f;		$(FC) -c $(FL2) $< -o $@
