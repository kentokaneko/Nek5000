### makefile automatically created by makenek 09/08/2017 10:46:31 ###
BINNAME=mas.nek5000
LIBNAME=libnek5000.mas.a
CASENAME:=ethier
CASEDIR:=/home/kaneko/ethier
S:=/home/kaneko/mas/core
SCMT:=/home/kaneko/mas/core/cmt
OPT_INCDIR=./
OBJDIR=mas.obj
MPI:=1
CMT:=0
...
FC:=mpif77
CC:=mpicc
FFLAGS:=-mcmodel=medium -r8 -Mpreprocess
CFLAGS:=-mcmodel=medium
PPPO=
PPS= MPI UNDERSCORE TIMER
USR:=
USR_LFLAGS:=-mcmodel=medium -L/home/kaneko/mas/3rd_party/gslib/src -lgs
VISIT:=0
VISIT_IFLAGS=
VISIT_LFLAGS=
